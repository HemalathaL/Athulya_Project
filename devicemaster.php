        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-md-offset-4" id="form">
                    ...
                    <form action="devicedb.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="inputname" class="form-label">Device</label> 
                        <br><br>
                        <input type="text" class="but"id="product" name="device">
                    </div>    
